...
//Implement save to palatte and local storage stuff
...
function savePalette(e) {
  ...
  generateLibraryPalettes(paletteObj, savedPalettes);
}
...
function generateLibraryPalettes(el, res) {
  ...
  paletteBtn.classList.add(el.nr);
  ...
  paletteBtn.addEventListener("click", (e) => {
    ...
    initialColors = [];
    res[paletteIndex].colors.forEach((color, index) => {
...
function getLocal() {
  if (localStorage.getItem("palettes") === null) {
    ...
    paletteObjects.forEach((paletteObject) => {
      generateLibraryPalettes(paletteObject, paletteObjects);
    });
  }
}
getLocal();
